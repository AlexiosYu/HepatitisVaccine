...
library(tidyr)
library(dplyr)
hep3_rake <- read_csv("./data/hep1_datat.csv")[,3:5]
...
for (i in c(6,10)) {
  load(sprintf("./Rdata/%s/pred_1000_%s.Rdata","D1",(i  + 2009)))
  ...
  write_sf(result_shp,sprintf("~/Yu/project/shape/rake/D1/5km_%s.shp",(i  + 2009)))
  ...
  write_csv(afrate,file=sprintf("~/Yu/project/shape/rake/D1/af_%s.csv",(i  + 2009)))
  ...
  gc()
  write_csv(pred_con_list$pred_result,file=sprintf("~/Yu/project/shape/rake/D1/con_%s.csv",(i  + 2009)))
  write_csv(pred_pro_list$pred_result,file=sprintf("~/Yu/project/shape/rake/D1/pro_%s.csv",(i  + 2009)))
  write_csv(pred_dis_list$pred_result,file=sprintf("~/Yu/project/shape/rake/D1/dis_%s.csv",(i  + 2009)))
}
